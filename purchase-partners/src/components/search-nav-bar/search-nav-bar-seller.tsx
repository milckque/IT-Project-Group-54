...
import SideBarSeller from "../side-bar/side-bar-seller";
...
function SearchNavBarSeller({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <SideBarSeller ref={sidebarRef} isOpen={isSidebarOpen} />
    </>
  );
}

export default SearchNavBarSeller;
